        ...
        if club != "football":
            ...
            for nflId in plot_df.nflId:
                ...
                hover_text_array.append(
                    f"nflId:{selected_player_df['nflId'].values[0]}<br>displayName:{selected_player_df['displayName'].values[0]}<br>x:{selected_player_df['x'].values[0]}<br>y:{selected_player_df['y'].values[0]}"
                )
            data.append(
                go.Scatter(
                    x=plot_df["x"],
